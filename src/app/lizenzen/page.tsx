...
function ToolCard({ tool }: { tool: Tool }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border-l-4 border-bbw-border p-4 hover:shadow-md transition-all">
      ...
      {/* Anleitung PDF Platzhalter */}
      {tool.anleitungPdf && (
        <div className="mt-2">
          <span className="inline-flex items-center gap-1 text-[0.65rem] px-2 py-1 rounded-md bg-gray-100 text-gray-600 font-medium">
            <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
            </svg>
            PDF-Anleitung (in Vorbereitung)
          </span>
        </div>
      )}
