        ...
        >
          ...
          <div className="text-xs text-amber-900 leading-relaxed space-y-3">
            ...
            <ul className="space-y-2">
              ...
              <li className="flex gap-2">
                <span className="shrink-0 font-bold">Freiwilligkeit:</span>
                <span>
                  Die Registrierung erfolgt freiwillig und darf nicht erzwungen
                  werden; persönliche Daten bei der Registrierung nur auf
                  freiwilliger Basis. <em>(Ziff. 4.3)</em>
                </span>
              </li>
              <li className="flex gap-2">
